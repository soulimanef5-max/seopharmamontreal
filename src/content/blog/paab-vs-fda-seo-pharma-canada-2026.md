...
> Pour les fondamentaux de la conformité canadienne, lisez d'abord notre [guide pratique SEO et conformité PAAB](/blog/seo-paab-conformite-guide-pratique-2026/).

---

## Deux régulateurs, deux philosophies

Aux États-Unis, c'est la [FDA](https://www.fda.gov), via son bureau [OPDP (Office of Prescription Drug Promotion)](https://www.fda.gov/about-fda/center-drug-evaluation-and-research-cder/office-prescription-drug-promotion-opdp), qui encadre la promotion des médicaments. Le modèle est **post-market** : vous publiez, et la FDA peut intervenir après coup si la communication enfreint les règles.

Au Canada, c'est le [PAAB](https://www.paab.ca) (Conseil consultatif de publicité pharmaceutique), reconnu par [Santé Canada](https://www.canada.ca/fr/sante-canada.html), qui révise la publicité destinée aux professionnels de santé. Le modèle est **pré-approbation** : pour le contenu brandé destiné aux professionnels, vous soumettez avant de publier.
...
> Sur la mécanique du balisage bilingue, voyez aussi notre approche du [SEO pour PME pharma au Québec](/blog/sante-canada-seo-pme-pharma-quebec-2025/).

---

## Ce qui ne change PAS d'un pays à l'autre

Bonne nouvelle : les fondamentaux de qualité sont universels. Des deux côtés de la frontière, Google applique les mêmes critères [E-E-A-T](https://developers.google.com/search/docs/fundamentals/creating-helpful-content) aux contenus santé :

- Auteur identifié avec credentials
- Sources primaires citées ([PubMed](https://pubmed.ncbi.nlm.nih.gov), organismes officiels)
...
Côté **canadien**, le contenu brandé destiné aux professionnels passe par la pré-approbation [PAAB](https://www.paab.ca) avant publication — une page non soumise qui se retrouve indexée est une non-conformité, pas un simple oubli SEO. Et la publicité au grand public reste plafonnée par l'article [C.01.044](https://laws-lois.justice.gc.ca/fra/reglements/C.R.C.,_ch._870/) du *Règlement sur les aliments et drogues* : nom, prix, quantité — rien d'autre.

Côté **Google**, le contenu santé est classé [YMYL](/blog/eeat-seo-medical-pharma-2025/) (« Your Money or Your Life ») : une page qui projette une allégation non étayée ne se contente pas d'enfreindre le PAAB, elle est aussi dépriorisée par les systèmes de qualité de Google. Vous cumulez alors les deux pénalités : réglementaire **et** algorithmique. L'erreur transfrontalière n'est donc jamais « juste » un problème de conformité — c'est aussi une perte sèche de visibilité.

---

## PAAB vs FDA à l'ère de la recherche générative (GEO)

Voici la dimension que presque personne n'anticipe encore. Les moteurs de recherche génératifs — [Google AI Overviews](https://developers.google.com/search/docs/fundamentals/ai-optimization-guide), ChatGPT, Perplexity, Gemini — ne respectent pas vos frontières. Ils synthétisent et citent des sources **sans tenir compte de votre ciblage géographique**.
...
- **Visibilité sur les requêtes informationnelles non brandées** (conditions, classes thérapeutiques, questions de patients) — via [Google Search Console](https://search.google.com/search-console).
...
Vous gérez du contenu pharma des deux côtés de la frontière ? [Discutons de votre architecture SEO bilingue](/#contact).
